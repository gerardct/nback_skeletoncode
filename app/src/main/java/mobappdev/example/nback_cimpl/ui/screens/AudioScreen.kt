    ...
    if (isPortraitAudio) {
        ...
        Scaffold(
            ...
            Column(
                ...
                ) {                    val audioColor = gameState.audioColor.value

                    Icon(
                        painter = painterResource(id = R.drawable.sound_on),
                        contentDescription = "Visual Icon",
                        modifier = Modifier.size(250.dp),
                        tint = when (audioColor) {
                            Color.Yellow -> Color.Yellow // Set button background color to green when button color is green
                            else -> Color.Black}
                    )
                }
                Row(
        ...
        Scaffold(
            ...
            Row(
                ...
                Column(
                    modifier = Modifier.weight(1f),
                    horizontalAlignment = Alignment.Start // Aligns content to the start (left in LTR languages)
                ) {
                    Row(
                        verticalAlignment = Alignment.CenterVertically,
